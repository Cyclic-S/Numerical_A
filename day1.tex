...
\end{ex}
\lstinputlisting[language=matlab]{day1/section1.m}
\begin{ex}
绘制二元函数图像.
$$
...
$$
\end{ex}
\lstinputlisting[language=matlab]{day1/section2.m}
...
\begin{ex}
	...
	$$
\end{ex}
\lstinputlisting[language=matlab]{day1/section3.m}
\begin{ex}
	计算$I_n=\int_0^1{\frac{x^n}{x+5}dx},(n=0,1,2,\cdots 20)$并估计误差.
\end{ex}
\lstinputlisting[language=matlab]{day1/section4.m}